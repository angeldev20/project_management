...
export default class InviteModal extends Component {
    ...
    constructor(props) {
        ...
        if (!id) {
            id = 'invite-modal-' + Math.floor((Math.random() * 100) + 1) + Math.floor((Math.random() * 100) + 1);
        }
    ...
    onConfirm(e) {
        ...
        const {onClientInvited} = this.props;
        const {id} = this.state;
        const $elem = $(`#${id}`);
        const $btn = $elem.find('.btn-confirm');
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="form-submit text-right">
                                ...
                                <a href="#" className="btn btn-success btn-confirm" onClick={(e) => this.onConfirm(e)}>Confirm</a>
                            </div>
                        </div>
                    </div>
                </div>
