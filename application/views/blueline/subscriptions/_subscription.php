...
<?php } ?>
 ...
 <div class="form-group">
        ...
        <input id="end_date" type="text" name="end_date" class="datepicker-linked date-empty form-control not-required" value="<?php if(isset($subscription) ){echo $subscription->end_date;} ?>"  />
</div> 
 ...
 <div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
        ...
        <input class="form-control" name="second_tax" type="text" value="<?php if(isset($subscription)){ echo $subscription->second_tax;}else{echo $core_settings->second_tax;} ?>" />
 </div>

 <div class="form-group">
        <label for="terms"><?=$this->lang->line('application_terms');?></label>
        <textarea id="terms" name="terms" class="textarea required summernote-modal form-control" style="height:100px"><?php if(isset($subscription) ){echo $subscription->terms;}else{ echo $core_settings->invoice_terms; }?></textarea>
</div> 
