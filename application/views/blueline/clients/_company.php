...
<div class="form-group">
        ...
        <?php $options = array();
                ...
                endforeach;
        if(is_object($company->client)){ $client = $company->client->id; }else{$client = "0";} 
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
                ...
                <input id="twitter" type="text" name="twitter" class="form-control" value="<?php if(isset($company)){echo $company->twitter;}?>" />
        </div>
        <div class="form-group">
                <label for="skype">Skype</label>
                <input id="skype" type="text" name="skype" class="form-control" value="<?php if(isset($company)){echo $company->skype;}?>" />
        </div>
        <div class="form-group">
                <label for="linkedin">LinkedIn</label>
                <input id="linkedin" type="text" name="linkedin" class="form-control" value="<?php if(isset($company)){echo $company->linkedin;}?>" />
        </div>
        <div class="form-group">
                <label for="facebook">Facebook</label>
                <input id="facebook" type="text" name="facebook" class="form-control" value="<?php if(isset($company)){echo $company->facebook;}?>" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
                <label for="instagram">Instagram</label>
                <input id="instagram" type="text" name="instagram" class="form-control" value="<?php if(isset($company)){echo $company->instagram;}?>" />
        </div>
        <div class="form-group">
                <label for="googleplus">Google Plus</label>
                <input id="googleplus" type="text" name="googleplus" class="form-control" value="<?php if(isset($company)){echo $company->googleplus;}?>" />
        </div>
        <div class="form-group">
                <label for="youtube">Youtube</label>
                <input id="youtube" type="text" name="youtube" class="form-control" value="<?php if(isset($company)){echo $company->youtube;}?>" />
        </div>
        <div class="form-group">
                <label for="pinterest">Pinterest</label>
                <input id="pinterest" type="text" name="pinterest" class="form-control" value="<?php if(isset($company)){echo $company->pinterest;}?>" />
        </div>
    </div>
</div>
