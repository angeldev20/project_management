...
<div class="form-group">
        <h5 for="email"><?=$this->lang->line('application_email');?> *</h5>
...
<!-- <div class="form-group hide">
        <h5 for="Company">Company <?php if(!isset($client)){echo "*";}?></h5>
        <input autocomplete="off" id="Company" type="text" name="Company" class="form-control" value="<?php if(isset($client)){echo $client->company_id;} ?>" />
</div> -->
<div class="form-group">
        <h5 for="password"><?=$this->lang->line('application_password');?> <?php if(!isset($client)){echo "*";}?></h5>
        <input autocomplete="off" id="password" type="password" name="password" class="form-control" autocomplete="new-password" value="" <?php if(!isset($client)){echo "required";}?> />
</div>
<div class="form-group">
        <h5>Profile Photo</h5>
        <div>
                <input id="uploadFile" class="form-control" placeholder="Upload a profile photo or logo" disabled="disabled" />
                <div class="fileUpload inside">
...
<div class="form-group">
<h5><?=$this->lang->line('application_module_access');?></h5>
<ul class="accesslist">
