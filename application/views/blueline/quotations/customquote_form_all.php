<div class="col-sm-12  col-md-12 main">  
	<div id="options" class="row">
		...
		<tr id="<?=$value->id;?>" >
			...
			<td><?=$value->name;?></td>
			<td><?php if($value->inactive == "1"){ echo '<span class="label label-error">'.$this->lang->line('application_inactive').'</span>'; }else{echo '<span class="label label-success">'.$this->lang->line('application_active').'</span>'; } ?></td>
