...
<div class="btn-group pull-right-responsive" style="margin-top: 9px;">
          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
            <img src="<?=base_url()?>assets/blueline/img/<?php if($this->input->cookie('fc2language') != ""){echo $this->input->cookie('fc2language');}else{echo $default_language;} ?>.png" style="margin-top:-1px" align="middle"> <span class="caret"></span>
          </button>
