<div id="row" class="grid">
	<div class="grid__col-sm-12 grid__col-md-3 grid__col-lg-3">
		<div class="list-group">
			...
			$badge = "";
			$active = "";
			if($value != "settings/backup" && $value != "settings/updates") {
			...
			if($value == "settings"){ $active = 'active';}?>
				<a style="<?php if($name == "SMTP Settings" | $name == "Bank Transfer") echo "display: none;"; ?>" class="list-group-item <?=$active;?>" id="<?php $val_id = explode("/", $value); if(!is_numeric(end($val_id))){echo end($val_id);}else{$num = count($val_id)-2; echo $val_id[$num];} ?>" href="<?=site_url($value);?>"><?=$badge?> <?=$name?></a>
			<?php } ?>
			<?php endforeach;?>
		</div>
	</div>
			...
			?>
				...
				<div class="table-div">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="invoice_address" class="form-control" value="<?=$settings->invoice_address;?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label><?=$this->lang->line('application_city');?></label>
									<input type="text" name="invoice_city" class="form-control" value="<?=$settings->invoice_city;?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label><?=$this->lang->line('application_phone');?></label>
									<input type="text" name="invoice_tel" class="form-control" value="<?=$settings->invoice_tel;?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label>
										...
										<button type="button" class="btn-option po pull-right" data-toggle="popover" data-placement="left" data-content="Full URL to your project installation. Including subfolder i.e. http://www.yoursite.com/sub/" data-original-title="Domain URL"> <i class="icon dripicons-information"></i></button>
									</label>
					...
					<div class="form-body">
						<div class="form-group">
							<label>
								<?=$this->lang->line('application_logo');?><button type="button" class="btn-option po pull-right" data-toggle="popover" data-placement="right" data-content="<div class='logo' style='padding:10px'><img src='https://spera-<?=ENVIRONMENT ?>.s3-us-west-2.amazonaws.com/<?=$_SESSION["accountUrlPrefix"]?>/<?=$settings->logo;?>'></div>" data-original-title="<?=$this->lang->line('application_logo');?>"> <i class="icon dripicons-preview"></i></button>
							</label>
							<div>
						...
						<div class="form-group">
							<label>
								<?=$this->lang->line('application_favicon');?><button type="button" class="btn-option po pull-right" data-toggle="popover" data-placement="right" data-content="<div class='logo' style='padding:10px'><img src='https://spera-<?=ENVIRONMENT ?>.s3-us-west-2.amazonaws.com/<?=$_SESSION["accountUrlPrefix"]?>/<?=$settings->favicon;?>'></div>" data-original-title="<?=$this->lang->line('application_favicon');?>"> <i class="icon dripicons-preview"></i></button>
							</label>
							<div>
								<input id="uploadFavicon" class="form-control uploadFile" placeholder="<?=$this->lang->line('application_choose_file');?>" disabled="disabled" />
								<div class="fileUpload btn btn-primary">
									<span><i class="icon dripicons-upload"></i><span class="hidden-xs"> <?=$this->lang->line('application_select');?></span></span>
									<input id="uploadBtn3" type="file" name="favicon" class="upload" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<label>
								<?=$this->lang->line('application_invoice');?> <?=$this->lang->line('application_logo');?><button type="button" class="btn-option po " data-toggle="popover" data-placement="right"  data-content="<div style='padding:10px'><img style='max-height: 50px; max-width: 200px; width: auto;' src='https://spera-<?=ENVIRONMENT ?>.s3-us-west-2.amazonaws.com/<?=$_SESSION["accountUrlPrefix"]?>/<?=$settings->invoice_logo;?>'></div>" data-original-title="<?=$this->lang->line('application_invoice');?> <?=$this->lang->line('application_logo');?>"> <i class="icon dripicons-preview"></i></button>
							</label>
							<div>
					...
					<div class="form-body">
						<div class="row">
							...
							<div class="col-md-2">
								<div class="form-group">
									<label><?=$this->lang->line('application_quotation');?></label>
									<div class="input-group">
					...
					<div class="form-body">
						<div class="row">
							...
							<div class="col-md-12">
									<div class="form-group">
										<label><?=$this->lang->line('application_timezone');?></label>
										<?php 
											$options = array();
					...
					<div class="form-header"><?=$this->lang->line('application_invoice_defaults');?></div>
					<div class="form-body">
						<div class="form-group">
					...
					<div class="form-header"><?=$this->lang->line('application_estimate');?> <?=$this->lang->line('application_default_terms');?></div>
					<div class="form-body">
						<div class="form-group">
							<label><?=$this->lang->line('application_default_terms');?></label>
