<div id="row" class="grid">
	...
	<div class="grid__col-sm-12 grid__col-md-9 grid__col-lg-9">
		<div class="table-head">Stripe <?=$this->lang->line('application_settings');?></div>
		<div class="table-div">
		<?php   
		$attributes = array('class' => '', 'id' => 'stripe');
		echo form_open_multipart($form_action, $attributes); 
		?>
		<br>
<div class="form-group">
<label><?=$this->lang->line('application_stripe_active');?></label>
            <input name="stripe" type="checkbox" class="checkbox" style="width:100%;" data-labelauty="<?=$this->lang->line('application_stripe_active');?>" value="1" <?php if($settings->stripe == "1"){ ?> checked="checked" <?php } ?>>

 </div>
<div class="form-group"><label><?=$this->lang->line('application_stripe_public_key');?></label>
			<input type="text" name="stripe_key" class="form-control" value="<?=$settings->stripe_key;?>">
</div>
<div class="form-group"><label><?=$this->lang->line('application_stripe_private_key');?></label>
			<input type="text" name="stripe_p_key" class="form-control" value="<?=$settings->stripe_p_key;?>">
</div>

<div class="form-group">
<label><?=$this->lang->line('application_iDEAL');?></label>
            <input name="stripe_ideal" type="checkbox" class="checkbox" style="width:100%;" data-labelauty="<?=$this->lang->line('application_enable_iDEAL');?>" value="1" <?php if($settings->stripe_ideal == "1"){ ?> checked="checked" <?php } ?>>
...
<div class="form-group"><label><?=$this->lang->line('application_currency');?></label>
			...
			<?php if($settings->stripe_currency != ""){ ?><option value="<?=$settings->stripe_currency;?>" selected=""><?=$settings->stripe_currency;?></option><?php } ?>
...
<div class="form-group no-border">
		...
		<br>
<div class="form-group">
			<label><?=$this->lang->line('application_authorize_active');?></label>
...
<div class="form-group no-border">
		...
		<div class="table-head">2Checkout <?=$this->lang->line('application_settings');?></div>
		<div class="table-div">
		<?php   
		$attributes = array('class' => '', 'id' => 'twocheckout');
		echo form_open_multipart($form_action, $attributes); 
		?>
		<br>
<div class="form-group">
			<label><?=$this->lang->line('application_twocheckout_active');?></label>
            <input name="twocheckout" type="checkbox" class="checkbox" style="width:100%;" data-labelauty="<?=$this->lang->line('application_twocheckout_active');?>" value="1" <?php if($settings->twocheckout == "1"){ ?> checked="checked" <?php } ?>>

 </div>
<div class="form-group"><label><?=$this->lang->line('application_seller_id');?></label>
			<input type="text" name="twocheckout_seller_id" class="form-control" value="<?=$settings->twocheckout_seller_id;?>">
</div>
<div class="form-group"><label><?=$this->lang->line('application_twocheckout_publishable_key');?></label>
			<input type="text" name="twocheckout_publishable_key" class="form-control" value="<?=$settings->twocheckout_publishable_key;?>">
</div>
<div class="form-group"><label><?=$this->lang->line('application_twocheckout_private_key');?></label>
...
<select id="twocheckout_currency" name="twocheckout_currency" class="chosen-select">
												<option value="<?=$settings->twocheckout_currency;?>" selected=""><?=$settings->twocheckout_currency;?></option>
