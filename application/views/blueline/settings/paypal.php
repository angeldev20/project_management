...
<div class="form-group">
			<label><?=$this->lang->line('application_paypal_active');?></label>
...
<div class="form-group">
	<label><?=$this->lang->line('application_paypal_ipn_address');?> <a class="cursor po " data-toggle="popover" data-placement="right" data-content="<?=$this->lang->line('application_paypal_ipn_help');?> <a target='_blank' href='https://luxsys.helpscoutdocs.com/article/15-paypal-ipn\'>More help!</a>" data-original-title="<?=$this->lang->line('application_paypal_ipn_address');?>"><i class="icon dripicons-question"></i></a></label>
			<br><small style="padding-left:10px"> 
					<span class="tag"><?=base_url()?>paypalipn</span>
			</small>
</div>
