			...
			<div class="panel-body settings">
				<div class="form-group tt">
					<label><?=$this->lang->line('application_cronjob_active');?> 
						<a class="cursor po " data-toggle="popover" data-placement="right" data-content="<?=$this->lang->line('application_cronjob_help');?> <a target='_blank' href='https://luxsys.helpscoutdocs.com/article/16-cronjob-configuration'>More help!</a>" data-original-title="<?=$this->lang->line('application_cronjob_active');?>"><i class="icon dripicons-question"></i></a>
					</label>
				...
				<div class="form-group">
					...
					<a class="cursor po" href="#" data-toggle="popover" data-placement="right" rel="popover" data-content="<?=$this->lang->line('application_cronjob_address_help');?>" data-original-title="<?=$this->lang->line('application_cronjob_address');?>"><i class="icon dripicons-question"></i></a> </label>  
					<br>
