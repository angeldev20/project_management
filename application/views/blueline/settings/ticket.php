<div id="row" class="grid">
	...
	<div class="grid__col-sm-12 grid__col-md-9 grid__col-lg-9">
		<?php if(!$imap_loaded) { ?>
			<div class='alert alert-danger'><i class="icon dripicons-warning"></i> Your server is missing the php_imap extension! Please contact your web host in order to activate this php extension.</div>
		<?php } ?>
		<?php   
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<input autocomplete="off" type="password" class="form-control" name="ticket_config_pass" value="<?=$settings->ticket_config_pass;?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label><?=$this->lang->line('application_imap_search');?> <a class="cursor po" rel="popover" data-toggle="popover" data-placement="right" data-content="<?=$this->lang->line('application_imap_search_help');?>" data-original-title="<?=$this->lang->line('application_imap_search');?>"><i class="icon dripicons-question"></i></a></label>
					<input type="text" class="form-control" name="ticket_config_search" value="<?=$settings->ticket_config_search;?>">
				</div>
				<div class="form-group">
					<label><?=$this->lang->line('application_postmaster_address');?>  <a class="cursor po" rel="popover" data-toggle="popover" data-placement="right" data-content="<?=$this->lang->line('application_postmaster_help');?>  <a target='_blank' href='https://luxsys.helpscoutdocs.com/article/16-cronjob-configuration'>More help!</a>" data-original-title="<?=$this->lang->line('application_postmaster_address');?>"><i class="icon dripicons-question"></i></a></label><br>
					...
					<?php foreach ($types as $value):?>
						<tr id="t<?=$value->id;?>" >
							...
							<td class="option" width="8%">
								...
								<a href="<?=base_url()?>settings/ticket_type/<?=$value->id;?>" class="btn-option" data-toggle="mainmodal"><i class="icon dripicons-gear"></i></a>
							</td>
						</tr>
					<?php endforeach;?>
				</tbody>
					...
					<?php foreach ($queues as $value):?>
						<tr id="q<?=$value->id;?>" >
							...
							<td class="option" width="8%">
								...
								<a href="<?=base_url()?>settings/ticket_queue/<?=$value->id;?>" class="btn-option" data-toggle="mainmodal"><i class="icon dripicons-gear"></i></a>
							</td>
						</tr>
					<?php endforeach;?>
				</tbody>
