<div class="col-sm-13  col-md-12 messages">
          ...
          <div class="row">
            <div class="messages-left col-sm-5  col-md-4" >
              ...
              <span id="deleted-folder"><i class="far fa-trash-alt-o"></i> <?=$this->lang->line('application_Deleted');?></span>
              ...
              <div class="message-list-menu">
                <div class="btn-group btn-group-justified">
                  ...
                  <a class="btn btn-default message-list-load deleted-folder" role="button" href="<?=base_url()?>messages/filter/deleted/0" title="<?=$this->lang->line('application_messages_show_deleted');?>"><i class="far fa-trash-alt-o"></i></a>
