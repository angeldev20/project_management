       ...
       <?php 
              if($value->userpic_u){
                if($value->userpic_u != 'no-pic.png'){
                  ...
                  echo $baseUrl . "files/media/".$value->userpic_u;
                }else{
                ...
                if($value->userpic_c != 'no-pic.png'){
                  $baseUrl = 'https://spera-' . ENVIRONMENT . '.s3-us-west-2.amazonaws.com/' . $_SESSION['accountUrlPrefix'] . '/';
                  echo $baseUrl . "files/media/".$value->userpic_c;
                }else{
