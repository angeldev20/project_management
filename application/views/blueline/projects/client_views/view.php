    ...
    <div class="col-xs-12 col-sm-12">
        <div class="row tile-row tile-view">
            <div class="col-md-1 col-xs-3">
                <div class="percentage easyPieChart" data-percent="<?= $project->progress; ?>">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="hidden-xs"><a href="#tasks-tab" aria-controls="tasks-tab" role="tab"
                                                             data-toggle="tab"><?= $this->lang->line( 'application_tasks' ); ?></a>
                </li>
                <li role="presentation" class="hidden-xs"><a href="#media-tab" aria-controls="media-tab" role="tab"
                ...
                <li role="presentation" class="dropdown visible-xs">
                    <a href="#" id="myTabDrop1" class="dropdown-toggle" data-toggle="dropdown"
                       ...
                       aria-expanded="false"><?= $this->lang->line( 'application_overview' ); ?> <span
                                class="caret"></span></a>
                    <ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                        <li role="presentation" class="active"><a href="#projectdetails-tab"
                                                                  aria-controls="projectdetails-tab" role="tab"
                                                                  data-toggle="tab"><?= $this->lang->line( 'application_project_details' ); ?></a>
                        </li>
                        ...
                        <li role="presentation"><a href="#media-tab" aria-controls="media-tab" role="tab"
                                                   data-toggle="tab"><?= $this->lang->line( 'application_files' ); ?></a>
                        </li>
...
<div class="tab-content">
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="subcont">
                <ul class="details col-xs-12 col-sm-12 col-md-6">
                    <li><span><?= $this->lang->line( 'application_project_id' ); ?>
                            :</span> <?= $core_settings->project_prefix; ?><?= $project->reference; ?></li>
                    <li><span><?= $this->lang->line( 'application_category' ); ?>:</span> <?= $project->category; ?>
                    </li>
                    <li><span><?= $this->lang->line( 'application_client' ); ?>
                            :</span> <?php if ( ! is_object( $project->company ) ){ ?> <a href="#"
                                                                                          class="label label-default"><?php echo $this->lang->line( 'application_no_client_assigned' );
							}else{ ?><a class="label label-success" href="#"><?php echo $project->company->name;
								} ?></a></li>
                ...
                <ul class="details col-xs-12 col-sm-12 col-md-6"><span class="visible-xs divider"></span>
                    <li><span><?= $this->lang->line( 'application_start_date' ); ?>
                            :</span> <?php $unix = human_to_unix( $project->start . ' 00:00' );
						echo date( $core_settings->date_format, $unix ); ?></li>
                    <li><span><?= $this->lang->line( 'application_deadline' ); ?>
                            :</span> <?php $unix = human_to_unix( $project->end . ' 00:00' );
						echo date( $core_settings->date_format, $unix ); ?></li>
                    <li><span><?= $this->lang->line( 'application_time_spent' ); ?>:</span> <?= $time_spent; ?> </li>
                    <li><span><?= $this->lang->line( 'application_created_on' ); ?>
                            :</span> <?php echo date( $core_settings->date_format . ' ' . $core_settings->date_time_format, $project->datetime ); ?>
                    </li>
                </ul>
                <br clear="both">
            </div>
            ...
            <div class="table-head"><?= $this->lang->line( 'application_tasks' ); ?>
				<?php if ( $project->enable_client_tasks == 1 ) { ?>
                    <span class=" pull-right">
                      <a href="<?= base_url() ?>cprojects/tasks/<?= $project->id; ?>/add" class="btn btn-primary"
                ...
                <ul id="task-list" class="todo sortlist ">
					...
					foreach ( $task_list as $value ): $count = $count + 1;
                        ...
                        <li id="task_<?= $value->id; ?>"
                            ...
                            <a href="<?= base_url() ?>cprojects/tasks/<?= $project->id; ?>/check/<?= $value->id; ?>"
                            ...
                            <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload"
                                   ...
                                   data-link="<?= base_url() ?>cprojects/tasks/<?= $project->id; ?>/check/<?= $value->id; ?>" <?php if ( $value->status == "done" ) {
								echo "checked";
							} ?> <?= $disable ?>/>
                            ...
                            <span class="pull-right">
								...
								<?php if ( $value->client_id != 0 ) {
									...
									<?php } else { ?>
                                        <a class="initials-avatar-circle tt"
                                           title="<?php echo $value->client->firstname . ' ' . $value->client->lastname; ?>"
                                        ><?php echo strtoupper( substr( $value->client->firstname, 0, 1 ) . substr( $value->client->lastname, 0, 1 ) ); ?></a>&nbsp;
									<?php } ?>
								<?php } ?>
                    ...
                    <div id="task-details-<?= $value->id; ?>" class="todo-details">
						...
						<?php if ( $disable == "" ) { ?>
                            <div class="grid grid--bleed task__options">
                                ...
                                <a href="<?= base_url(); ?>cprojects/task_start_stop_timer/<?= $value->id ?>"
                                   data-timerid="timer<?= $value->id; ?>"
                                   class="grid__col-6 grid__col--bleed center ajax-silent task__options__button task__options__button--green task__options__timer timer<?= $value->id; ?> <?= $start ?>">
									<?= $this->lang->line( 'application_start_timer' ); ?>
                                </a>

                                <a href="<?= base_url(); ?>cprojects/task_start_stop_timer/<?= $value->id ?>"
                                   data-timerid="timer<?= $value->id; ?>"
                                   class="grid__col-6 grid__col--bleed center ajax-silent task__options__button task__options__button--red task__options__timer timer<?= $value->id; ?> <?= $stop ?>">
									<?= $this->lang->line( 'application_stop_timer' ); ?>
                                </a>

                                <a href="<?= base_url(); ?>cprojects/tasks/<?= $project->id ?>/update/<?= $value->id ?>"
                                   class="grid__col-6 grid__col--bleed task__options__button" data-toggle="mainmodal">
                        ...
                        <ul class="details">
                            ...
                            <li class="comment-list-li">
                                ...
                                <div class="form-group filled chat_message_input">
                                    ...
                                    <textarea name="message" class="form-control autogrow message"
                                        ...
                                        <li>
											...
											<?php if ( $comments->attachment != "" ) { ?>
                                                <div>
													...
													<?php } else { ?>
                                                        <a class="tt"
                                                           href="<?= base_url() ?>cprojects/download/false/<?= $comments->attachment_link ?>"
    ...
    <a href="<?= base_url() ?>cprojects/media/<?= $project->id; ?>/add" class="btn btn-primary"
       data-toggle="mainmodal"><?= $this->lang->line( 'application_add_media' ); ?></a>
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="media-list-view-container hidden">
                <div class="table-head"><?= $this->lang->line( 'application_files' ); ?> <span class=" pull-right"><a
                                href="<?= base_url() ?>cprojects/media/<?= $project->id; ?>/add" class="btn btn-primary"
                ...
                <div class="table-div min-height-410">
                    <table id="media" class="table data-media"
                           rel="<?= base_url() ?>cprojects/media/<?= $project->id; ?>" cellspacing="0" cellpadding="0">
                        <thead>
                        <tr>
                            <th class="hidden"></th>
                            ...
                            <tr id="<?= $value->id; ?>">
                                ...
                                <td class="option " width="10%">
                                    <button type="button" class="btn-option btn-xs po" data-toggle="popover"
                                            data-placement="left"
                                            data-content="<a class='btn btn-danger po-delete ajax-silent' href='<?= base_url() ?>cprojects/media/<?= $project->id; ?>/delete/<?= $value->id; ?>'><?= $this->lang->line( 'application_yes_im_sure' ); ?></a> <button class='btn po-close'><?= $this->lang->line( 'application_no' ); ?></button> <input type='hidden' name='td-id' class='id' value='<?= $value->id; ?>'>"
                                            data-original-title="<b><?= $this->lang->line( 'application_really_delete' ); ?></b>">
                                        <i class="icon dripicons-cross"></i></button>
                                    <a href="<?= base_url() ?>cprojects/media/<?= $project->id; ?>/update/<?= $value->id; ?>"
                    ...
                    <li class="comment-item add-comment">
                        ...
                        <div class="comment-pic">
                            <img class="img-circle tt"
                                 ...
                                 src="<?= get_user_pic( $this->client->userpic, $this->client->email ); ?>">
                        ...
                        <div class="comment-content">
                            ...
                            <p>
                                <small class="text-muted"><span
                                            class="comment-writer"><?= $this->client->firstname ?> <?= $this->client->lastname ?></span>
                        ...
                        <li class="comment-item">
                            <div class="comment-pic">
								<?php if ( $writer != false ) { ?>
									...
									<?php } else { ?>
                                        <a class="initials-avatar-circle tt" title="<?= $writer ?>"><?= $initials ?></a>
									<?php } ?>
