       ...
       <div class="col-xs-12 col-sm-3">
		...
		<div class="subcont">
			<ul class="details">
				...
				<li><span><?=$this->lang->line('application_uploaded_by');?>:</span> <a class="label label-info"><?php if(is_object($media->user)){ ?><?=$media->user->firstname;?> <?=$media->user->lastname;?><?php }else{ ?> <?=$media->client->firstname;?> <?=$media->client->lastname;?><?php } ?></a></li>
