        ...
        <tbody id="newRows">
                <?php foreach ($timesheets as $value):  ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php   if(!empty($value->start)){echo date($core_settings->date_format.' '.$core_settings->date_time_format, $value->start); }else{ echo "-";}?>
                        
                            </td>
                            <td>
                                <?php   if(!empty($value->end)){echo date($core_settings->date_format.' '.$core_settings->date_time_format, $value->end); }else{ echo "-";} ?>
                            </td>
