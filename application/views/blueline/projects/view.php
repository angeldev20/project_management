<script>
    ...
    foreach ($project->project_has_workers as $workers):
        $mention_names[] = $workers->user->username;
    endforeach;
    ?>
    app.mentions = <?php echo json_encode($mention_names); ?>;
</script>

<link rel="stylesheet" href="<?= base_url() ?>assets/blueline/css/chat.css"/>
<script type="text/javascript" src="<?= base_url() ?>assets/blueline/js/chat.js"></script>
    ...
    <div class="col-xs-12 col-sm-12">
        ...
        <div class="row tile-row tile-view">
            <div class="col-md-1 col-xs-3">
                <div class="percentage easyPieChart" id="tile-pie" data-percent="<?= $project->progress; ?>">
                    <span><?= $project->progress; ?>%</span></div>

            </div>
            <div class="col-md-11 col-xs-9 smallscreen">
                <h1><?= $project->name; ?></h1>
                <p class="truncate description"><?= ( ! empty( $project->description ) ? $project->description : '<a href="' . base_url() . 'projects/update/' . $project->id . '" data-toggle="mainmodal" data-target="#mainModal" style="color: #CCC;">Add description</a>' ); ?></p>
            </div>

            <ul class="nav nav-tabs" role="tablist" id="projectTabs">
                <li role="presentation" class="active hidden-xs"><a href="#projectdetails-tab"
                                                                    aria-controls="projectdetails-tab" role="tab"
                                                                    data-toggle="tab"><?= $this->lang->line( 'application_project_details' ); ?></a>
                </li>
                <li role="presentation" class="hidden-xs"><a href="#tasks-tab" id="task_menu_link"
                                                             aria-controls="tasks-tab" role="tab"
                                                             data-toggle="tab"><?php if ( $mytasks != 0 ) { ?><span
                                class="badge"><?= $mytasks ?></span><?php } ?><?= $this->lang->line( 'application_tasks' ); ?>
                    </a></li>
                <li role="presentation" class="hidden-xs"><a href="#milestones-tab" aria-controls="tasks-tab" role="tab"
                                                             data-toggle="tab"><?= $this->lang->line( 'application_milestones' ); ?></a>
                </li>
                <li role="presentation" class="hidden-xs"><a href="#gantt-tab" class="resize-gantt"
                                                             aria-controls="gantt-tab" role="tab"
                                                             data-toggle="tab"><?= $this->lang->line( 'application_gantt' ); ?></a>
                </li>
                <li role="presentation" class="hidden-xs"><a href="#media-tab" class="media-tab-trigger"
                                                             aria-controls="media-tab" role="tab"
                                                             data-toggle="tab"><?= $this->lang->line( 'application_files' ); ?></a>
                </li>
                <li role="presentation" class="hidden-xs"><a href="#notes-tab" aria-controls="notes-tab" role="tab"
                                                             data-toggle="tab"><?= $this->lang->line( 'application_notes' ); ?></a>
                </li>
				<?php if ( $invoice_access ) { ?>
                    <li role="presentation" class="hidden-xs"><a href="#invoices-tab" aria-controls="invoices-tab"
                                                                 role="tab"
                                                                 data-toggle="tab"><?= $this->lang->line( 'application_invoices' ); ?></a>
                    </li>
				<?php } ?>
                <li role="presentation" class="hidden-xs"><a href="#activities-tab" aria-controls="activities-tab"
                                                             role="tab"
                                                             data-toggle="tab"><?= $this->lang->line( 'application_activities' ); ?></a>
                </li>

                <!--li role="presentation" class="hidden-xs"><a href="#chat-tab" aria-controls="chat-tab"
                                                             role="tab"
                                                             data-toggle="tab"><?= $this->lang->line( 'application_chat' ); ?></a>
                </li-->
                ...
                <li role="presentation" class="dropdown visible-xs">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                        <li role="presentation"><a href="#projectdetails-tab" aria-controls="projectdetails-tab"
                                                   role="tab"
                                                   data-toggle="tab"><?= $this->lang->line( 'application_project_details' ); ?></a>
                        </li>
                        <li role="presentation"><a href="#tasks-tab" aria-controls="tasks-tab" role="tab"
                                                   data-toggle="tab"><?php if ( $mytasks != 0 ) { ?><span
                                        class="badge submenu-badge"><?= $mytasks ?></span><?php } ?><?= $this->lang->line( 'application_tasks' ); ?>
                            </a></li>
                        <li role="presentation"><a href="#milestones-tab" aria-controls="tasks-tab" role="tab"
                                                   data-toggle="tab"><?= $this->lang->line( 'application_milestones' ); ?></a>
                        </li>
                        <li role="presentation"><a href="#gantt-tab" class="resize-gantt" aria-controls="gantt-tab"
                                                   role="tab"
                                                   data-toggle="tab"><?= $this->lang->line( 'application_gantt' ); ?></a>
                        </li>
                        <li role="presentation"><a href="#media-tab" aria-controls="media-tab" class="media-tab-trigger"
                                                   role="tab"
                                                   data-toggle="tab"><?= $this->lang->line( 'application_files' ); ?></a>
                        </li>
						...
						<?php if ( $invoice_access ) { ?>
                            <li role="presentation"><a href="#invoices-tab" aria-controls="invoices-tab" role="tab"
                                                       data-toggle="tab"><?= $this->lang->line( 'application_invoices' ); ?></a>
                            </li>
						<?php } ?>
                        <li role="presentation"><a href="#activities-tab" aria-controls="activities-tab" role="tab"
                                                   data-toggle="tab"><?= $this->lang->line( 'application_activities' ); ?></a>
                        </li>
                        <li role="presentation"><a href="#chat-tab" aria-controls="chat-tab" role="tab"
                                                   data-toggle="tab"><?= $this->lang->line( 'application_chat' ); ?></a>
                    </ul>
                </li>

                <li class="pull-right">
                    <a href="<?= base_url() ?>projects/copy/<?= $project->id; ?>" class="btn-option tt"
                       title="<?= $this->lang->line( 'application_copy_project' ); ?>" data-toggle="mainmodal"><i
                                class="icon dripicons-duplicate"></i></a>

                </li>
                <li class="pull-right">
					<?php if ( $project->sticky == 0 ) { ?>
                        <a href="<?= base_url() ?>projects/sticky/<?= $project->id; ?>" class="tt"
                           title="<?= $this->lang->line( 'application_sticky' ); ?>"><i
                                    class="icon dripicons-star"></i></a>
					<?php } else { ?>
                        <a href="<?= base_url() ?>projects/sticky/<?= $project->id; ?>" class="tt"
                           title="<?= $this->lang->line( 'application_sticky' ); ?>"><i
                                    class="icon dripicons-star"></i></a>
                ...
                <li class="pull-right">
                    <a href="<?= base_url() ?>projects/update/<?= $project->id; ?>" class="tt"
                       title="<?= $this->lang->line( 'application_settings' ); ?>" data-toggle="mainmodal"
                       data-target="#mainModal"><i class="icon dripicons-gear"></i></a>
                </li>
                <li class="pull-right">
					<?php if ( $is_tracking ) { ?>

                        <a href="<?= base_url() ?>projects/tracking/<?= $project->id; ?>"
                           class="tt red project-global-timer"
                           title="<?= $this->lang->line( 'application_stop_timer' ); ?>"><span id="timerGlobal"
                                                                                               class="badge"></span></a>
                        <script>$(document).ready(function () {
                                startTimer("", "<?=$timertime;?>", "#timerGlobal");
                            });</script>
					<?php }else{ ?>
                        <a href="<?= base_url() ?>projects/tracking/<?= $project->id; ?>" class="tt green"
                           title="<?= $this->lang->line( 'application_start_timer' ); ?>"><i
                                    class="icon dripicons-clock"></i> </a>
					<?php } ?>
                </li>
                <li class="pull-right">
					<?php if ( $project->id < $last_project->id ) { ?>
                        <a href="<?= base_url() ?>projects/view/<?= $project->id + 1; ?>" class="tt"
                           title="<?= $this->lang->line( 'application_next' ); ?>"><i
                                    class="icon dripicons-arrow-thin-right"></i> </a>
					<?php } ?>
                </li>
                <li class="pull-right">
					<?php if ( $project->id - 1 > $first_project->id ) { ?>
                        <a href="<?= base_url() ?>projects/view/<?= $project->id - 1; ?>" class="tt"
                           title="<?= $this->lang->line( 'application_back' ); ?>"><i
                                    class="icon dripicons-arrow-thin-left"></i> </a>
					<?php } ?>
                </li>
...
<div class="tab-content">
    ...
    <div class="row tab-pane fade in active" role="tabpanel" id="projectdetails-tab">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
            <div class="table-head"><?= $this->lang->line( 'application_project_details' ); ?> <span
                        class=" pull-right option-icon"> <a href="<?= base_url() ?>projects/update/<?= $project->id; ?>"
                                                            data-toggle="mainmodal" data-target="#mainModal"><i
                                class="icon dripicons-gear"></i></a></span></div>

            <div class="subcont">
                <ul class="details col-xs-12 col-sm-12">
                    <li>
                        <span><?= $this->lang->line( 'application_project_id' ); ?></span> <?= $core_settings->project_prefix; ?><?= $project->reference; ?>
                    </li>
                    <li><span><?= $this->lang->line( 'application_category' ); ?></span> <?= $project->category; ?></li>
                    <li>
                        <span><?= $this->lang->line( 'application_client' ); ?></span> <?php if ( ! is_object( $project->company ) ){ ?>
                        <a href="#"
                           class="label label-default"><?php echo $this->lang->line( 'application_no_client_assigned' );
							}else{ ?><a class="label label-success"
                                        href="<?= base_url() ?>clients/view/<?= $project->company->id; ?>"><?php echo $project->company->name;
								} ?></a></li>
                    <li>
                        <span><?= $this->lang->line( 'application_start_date' ); ?></span> <?php $unix = human_to_unix( $project->start . ' 00:00' );
						echo date( $core_settings->date_format, $unix ); ?></li>
                    <li>
                        <span><?= $this->lang->line( 'application_deadline' ); ?></span> <?php $unix = human_to_unix( $project->end . ' 00:00' );
						echo date( $core_settings->date_format, $unix ); ?></li>
                    <li>
                        <span><?= $this->lang->line( 'application_project' ); ?> <?= $this->lang->line( 'application_time_spent' ); ?></span> <?= $time_spent; ?>
                        <a href="<?= base_url() ?>projects/timer_reset/<?= $project->id; ?>" class="tt"
                           title="<?= $this->lang->line( 'application_reset_timer' ); ?>"><i
                                    class="icon dripicons-time-reverse"></i></a> <a
                                href="<?= base_url() ?>projects/timer_set/<?= $project->id; ?>" data-toggle="mainmodal"
                                class="tt" style="    margin-left: 7px;"
                                title="<?= $this->lang->line( 'application_timer_set' ); ?>"><i
                                    class="icon dripicons-clock"></i></a></li>
                    <li>
                        <span><?= $this->lang->line( 'application_tasks' ); ?> <?= $this->lang->line( 'application_time_spent' ); ?></span> <?= Project::getAllTasksTime( $project->id ); ?>
                    </li>

                    <li>
                        <span><?= $this->lang->line( 'application_created_on' ); ?></span> <?php echo date( $core_settings->date_format . ' ' . $core_settings->date_time_format, $project->datetime ); ?>
                    </li>
                </ul>
                <br clear="both">
            </div>
                        ...
                        <div class="tile-extended-header">
                            <div class="grid tile-extended-header">
                                ...
                                <div class="grid__col-12 grid__col--bleed grid--align-self-end">
                                    <div class="tile-body">
                                        <canvas id="projectChart" width="auto" height="80"
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    <div class="tile-base tile-with-icon">
                        <div class="tile-icon hidden-md hidden-sm" style="margin: -11px 36px 2px 0px;"><i
                                    class="ion-ios-people-outline"></i></div>
                        ...
                        <div class="tile-bottom">
                            <div class="progress tile-progress tile-progress--red">
                                <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                                     aria-valuemax="100" style="width: <?= $assigneduserspercent ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="tile-base tile-with-icon">
                        ...
                        <div class="tile-body">
                            <div class="number" id="number1">
								<?= $time_left ?>
                                <small> / <?= $time_days ?></small>
                            </div>
                        </div>
                        <div class="tile-bottom">
                            <div class="progress tile-progress tile-progress--green">
                                <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                                     aria-valuemax="100" style="width: <?= $timeleftpercent ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="tile-base tile-with-icon">
                        ...
                        <div class="tile-body">
                            <div class="number" id="number1">
								<?= $opentasks ?>
                                <small> / <?= $alltasks ?></small>
                            </div>
                        </div>
                        <div class="tile-bottom">
                            <div class="progress tile-progress tile-progress--purple">
                                <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                                     aria-valuemax="100" style="width: <?= $opentaskspercent ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">
            ...
            <div class="stdpad">
                <div class="table-head"><?= $this->lang->line( 'application_assigned_agents' ); ?>
                  ...
                  <a href="<?= base_url() ?>projects/assign/<?= $project->id; ?>" class="btn btn-primary tt"
                     style="padding: 4px 7px 3px;" data-toggle="mainmodal"
                     title="<?= $this->lang->line( 'application_add_remove_team_members' ); ?>"><i
                              class="icon dripicons-gear"></i>
                  </a>
            </span>
                ...
                <div id="main-nano-wrapper" class="nano">
                    <div class="nano-content">
                        <ul class="user-list">
							<?php
							$is_admin = $this->user->admin == 1;
                            foreach ( $project->project_has_workers as $workers ):
                            $is_user_task = $workers->user->id == $this->user->id;

                            if($project->hide_tasks && !$is_user_task && !$is_admin) {
                                continue;
                            }

							echo "<li>";
							$pic = get_user_pic( $workers->user->userpic, $workers->user->email );
							if ( $pic ) {
								echo "<img src=\"$pic\" class=\"img-circle list-profile-img \" height=\"21\"> ";
							} else {
								echo '<a class="initials-avatar-circle" style="width: 21px; height: 21px; padding: 4px;">' . strtoupper( substr( $workers->user->firstname, 0, 1 ) . substr( $workers->user->lastname, 0, 1 ) ) . '</a>&nbsp;';
							}
							echo "<span class=\"user-list-name\">" . $workers->user->firstname . " " . $workers->user->lastname; ?></span>
                            <ul class="details">
                                <li>
    ...
    <div class="row tab-pane fade" role="tabpanel" id="tasks-tab">
        <div class="col-xs-12 col-sm-12 task-container-left">
            <div class="table-head"><?= $this->lang->line( 'application_tasks' ); ?>
                <span class=" pull-right">
                 <a class="btn btn-success toggle-closed-tasks tt"
                    data-original-title="<?= $this->lang->line( 'application_hide_completed_tasks' ); ?>">
                          <i class="ion-checkmark-circled"></i>
                      </a>
                      <a href="<?= base_url() ?>projects/tasks/<?= $project->id; ?>/add" class="btn btn-primary"
            ...
            <div class="subcont no-padding min-height-410">
                <div class="task__quick-add">
					<?php $attributes = array(
						...
						'data-reload2' => 'milestones-list',
						'data-reload3' => 'taskviewer-content',
						'data-baseurl' => base_url() . 'projects/tasks/' . $project->id . '/',
						'id'           => '_task'
					);
					$formURL          = base_url() . "projects/quicktask";
					echo form_open( $formURL, $attributes ); ?>
                    <textarea class="summernote-nb-with-mentions" id="quick-add-task-name" autocomplete="off" name="name"
                              placeholder="<?= $this->lang->line( 'application_add_new_task...' ); ?>"></textarea>
                    <div class="priority-selector--group">
                        <span class="priority-selector priority-selector--high tt" data-priority="3"
                              data-original-title="high"></span>
                        <span class="priority-selector priority-selector--mid tt" data-priority="2"
                              data-original-title="Medium"></span>
                        <span class="priority-selector priority-selector--low tt" data-priority="1"
                              data-original-title="Low"></span>
                    </div>
                    ...
                    <li id="task_dummy" class="open list-item owntask hidden">
                        ...
                        <input id="dummy-href2" name="form-field-checkbox"
                               class="checkbox-nolabel task-check dynamic-reload" data-reload="tile-pie" type="checkbox"
                               data-link=""/>
                        <span class="lbl"> <p class="truncate name pointer"
                                              data-taskid="task-details-dummy"> </p></span>
                        <span class="pull-right">
                            <?php
                            if ( $this->user->id != 0 ) {
	                            $image = get_user_pic( $this->user->userpic, $this->user->email );
	                            ?>
	                            <?php if ( $image ) { ?>
                                    <img class="img-circle list-profile-img tt hide"
                                         title="<?= $this->user->firstname; ?> <?= $this->user->lastname; ?>"
                                         src="<?= $image; ?>">
	                            <?php } else { ?>
                                    <a class="initials-avatar-circle tt hide"
                                       title="<?php echo $this->user->firstname . ' ' . $this->user->lastname; ?>"><?php echo strtoupper( substr( $this->user->firstname, 0, 1 ) . substr( $this->user->lastname, 0, 1 ) ); ?></a>&nbsp;
	                            <?php } ?>
                            <?php } ?>
                ...
                <div>
                    <ul id="task-list" class="todo sortlist sortable-list">
						<?php
						$count     = 0;
						$task_list = ( $project->hide_tasks == 1 && $this->user->admin == 0 ) ? $allmytasks : array_reverse($project->project_has_tasks);
						foreach ( $task_list as $value ): $count = $count + 1; ?>

                            <li id="task_<?= $value->id; ?>"
                                class="<?= $value->status; ?> priority<?= $value->priority; ?> list-item <?php if ( $value->user_id == $this->user->id ) {
								    echo "owntask";
							    } ?>">

                                <a href="<?= base_url() ?>projects/tasks/<?= $project->id; ?>/check/<?= $value->id; ?>"
                                   class="ajax-silent task-check"></a>

                                <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload"
                                       data-reload="tile-pie" type="checkbox"
                                ...
                                />
                                <span class="lbl"> <p class="truncate name pointer"
                                                      data-taskid="task-details-<?= $value->id; ?>"><?= $value->name; ?></p></span>
                                <span class="pull-right">
                                  <?php if ( $value->invoice_id != 0 ) { ?>
                                      <span class="list-button task-lock-<?= $value->id ?>">
                                          <i class="icon dripicons-lock tt" title=""
                                             data-original-title="<?= $this->lang->line( 'application_task_has_been_invoiced' ); ?>"></i>
                                        </span>
                                  <?php } ?>
									<?php if ( $value->tracking != 0 ) { ?>
                                        <span class="list-button">
                                          <i class="icon dripicons-stopwatch tt" title=""
                                             data-original-title="<?= $this->lang->line( 'application_running_timer' ); ?>"></i>
                                        </span>
									<?php } ?>
									<?php if ( $value->public != 0 ) { ?>
                                        <span class="list-button">
                                          <i class="icon dripicons-preview task__icon tt" title=""
                                             data-original-title="<?= $this->lang->line( 'application_task_public' ); ?>"></i>
                                        </span>
									<?php } ?>
									<?php if ( $value->created_by_client != 0 ) { ?>
                                        <span class="list-button">
                                          <i class="ion-bookmark task__icon tt" title=""
                                             data-original-title="<?= $this->lang->line( 'application_created_by_client' ); ?>"></i>
                                        </span>
									<?php } ?>
									<?php
									if ( $value->task_has_workers ) {
										foreach($value->task_has_workers as $worker) {
											$image = get_user_pic( $worker->user->userpic, $worker->user->email );
											?>
											<?php if ( $image ) { ?>
                                                <img class="img-circle list-profile-img tt"
                                                     title="<?= $worker->user->firstname; ?> <?= $worker->user->lastname; ?>"
                                                     src="<?= $image; ?>">
											<?php } else { ?>
                                                <a class="initials-avatar-circle tt"
                                                   title="<?php echo $worker->user->firstname . ' ' . $worker->user->lastname; ?>"><?php echo strtoupper( substr( $worker->user->firstname, 0, 1 ) . substr( $worker->user->lastname, 0, 1 ) ); ?></a>&nbsp;
											<?php } ?>
										<?php } ?>
									<?php } ?>
									<?php if ( $value->client_id != 0 ) {
										...
										<?php if ( $image ) { ?>
                                            <img class="img-circle list-profile-img tt"
                                                 title="<?= $value->client->firstname; ?> <?= $value->client->lastname; ?>"
                                                 src="<?= $image; ?>">
										<?php } else { ?>
                                            <a class="initials-avatar-circle tt"
                                               title="<?php echo $value->client->firstname . ' ' . $value->client->lastname; ?>"><?php echo strtoupper( substr( $value->client->firstname, 0, 1 ) . substr( $value->client->lastname, 0, 1 ) ); ?></a>&nbsp;
										<?php } ?>
									<?php } ?>
        ...
        <div class="col-sm-4 pin-to-top">
            ...
            <div id="taskviewer-content" class="subcont taskviewer-content">
				<?php foreach ( $task_list as $value ): ?>
                    <div id="task-details-<?= $value->id; ?>" class="todo-details">
                        <i class="ion-close pull-right todo__close"></i>
                        <span class="x-edit-large"><h4 data-name="name" class="editable synced-edit"
                                                       data-syncto="task_<?= $value->id; ?>"
                                                       data-inputclass="inline__edit__title" data-showbuttons="false"
                                                       data-type="text" data-pk="<?= $value->id; ?>"
                                                       data-url="<?= base_url() ?>projects/task_change_attribute">
                            <?= $value->name; ?>
                        </h4> </span>
                        <div class="progress tt" style="margin-top: 10px;"
                             data-original-title="<?= $value->progress; ?>%">
                            <div id="progress-bar<?= $value->id; ?>" class="progress-bar" role="progressbar"
                        ...
                        <ul class="details">
							...
							<?php if ( $value->invoice_id != 0 ) { ?>
                                <li class="task-lock">
                                <span class="red">
                                    <i class="icon dripicons-lock tt unlock-task ajax-click-request"
                                       data-hide="task-lock"
                                       data-url="<?= base_url(); ?>projects/tasks/<?= $value->project_id ?>/unlock/<?= $value->id ?>"
                                       title=""
                                       data-original-title="<?= $this->lang->line( 'application_unlock_task' ); ?>"></i>
	                                <?= $this->lang->line( 'application_task_has_been_invoiced' ); ?>: <a
                                            href="<?= base_url(); ?>invoices/view/<?= $value->invoice_id ?>"><?= $core_settings->invoice_prefix; ?><?= $value->invoice->reference; ?></a>
                                </span>
                                </li>
							<?php } ?>
                            <li>
                                ...
                                <span id="timer<?= $value->id; ?>" class="timer__span badge timer__badge <?= $state ?>"
                                      data-timerstate="<?= $state; ?>" data-timertime="<?= $timertime; ?>"></span>
                                <script>$(document).ready(function () {
								...
								<?php if ( $value->user_id == $this->user->id && $value->invoice_id == 0 ) { ?>
                                    ...
                                    <a href="<?= base_url(); ?>projects/task_start_stop_timer/<?= $value->id ?>"
                                       data-timerid="timer<?= $value->id; ?>"
                                       class=" ajax-silent task__options__button task__options__button--green task__options__timer timer<?= $value->id; ?> <?= $start ?>">
										<?= $this->lang->line( 'application_start_timer' ); ?>
                                    </a>

                                    <a href="<?= base_url(); ?>projects/task_start_stop_timer/<?= $value->id ?>"
                                       data-timerid="timer<?= $value->id; ?>"
                                       class="ajax-silent task__options__button task__options__button--red task__options__timer timer<?= $value->id; ?> <?= $stop ?>">
										<?= $this->lang->line( 'application_stop_timer' ); ?>
                                    </a>

								<?php } ?>
                                <a href="<?= base_url(); ?>projects/timesheets/<?= $value->id ?>"
                                   class="timer__icon_button tt"
                                   data-original-title="<?= $this->lang->line( 'application_timesheet' ); ?>"
                                   data-toggle="mainmodal">
                                    <i class="icon dripicons-list"></i>
                                </a>
                            </li>
                            <li>
                                <span><?= $this->lang->line( 'application_assigned_to_team' ); ?></span>
								<?php if(count($value->task_has_workers) > 0) {
									foreach ( $value->task_has_workers as $worker ) {
										$pic = get_user_pic( $worker->user->userpic, $worker->user->email );
										if ( $pic ) {
											echo "<img src=\"$pic\" class=\"img-circle list-profile-img \" height=\"21px\"> ";
										} else {
											?>
                                            <a class="initials-avatar-circle"
                                               title="<?php echo $worker->user->firstname . ' ' . $worker->user->lastname; ?>"
                                            ><?php echo strtoupper( substr( $worker->user->firstname, 0, 1 ) . substr( $worker->user->lastname, 0, 1 ) ); ?></a>
											<?php
										}
										echo $worker->user->firstname . " " . $worker->user->lastname;
									}
								} else {
                            ...
                            <li>
                                ...
                                <a href="#" data-name="progress" class="editable synced-process-edit"
                                   data-syncto="progress-bar<?= $value->id; ?>" data-type="range"
                                   data-pk="<?= $value->id; ?>"
                                   data-url="<?= base_url() ?>projects/task_change_attribute">
									<?= $value->progress; ?>
                                </a>
							...
							<?php if ( $value->created_by_client != 0 && $value->created_by_client != "" ) { ?>
                                <li>
									...
									<?php $pic = get_user_pic( $value->creator->userpic, $value->creator->email );
									echo "<img src=\"$pic\" class=\"img-circle list-profile-img \" height=\"21px\"> "; ?>
							...
							<?php if ( $value->client_id != 0 && $value->client_id != "" ) { ?>
                                <li>
									...
									<?php $pic = get_user_pic( $value->client->userpic, $value->client->email );
									echo "<img src=\"$pic\" class=\"img-circle list-profile-img \" height=\"21px\"> "; ?>
                            ...
                            <li class="subtasks" style="border-bottom: 0;">
                                <span><?= $this->lang->line( 'application_sub_tasks' ); ?></span>
								<?php echo form_open( base_url() . 'projects/quicksubtask', [
									'class' => 'quick-add-subtask',
									'data-reload'  => 'task-list',
									'data-reload2' => 'milestones-list',
									'data-reload3' => 'taskviewer-content',
									'data-reload4' => 'task-subtasks-' . $value->id,
									'data-baseurl' => base_url() . 'projects/subtasks/' . $project->id . '/' . $value->id . '/',
									'data-taskid' => $value->id
								] ); ?>
                                <input type="text" name="name" placeholder="<?= $this->lang->line( 'application_new_sub_tasks' ); ?>" />
                                <input type="hidden" name="task_id" value="<?=$value->id?>" />
                            <li id="subtask-dummy-<?= $value->id ?>" class="open list-item owntask hidden">

                                <a href="" id="subtask-check-link"
                                   class="ajax-silent task-check"></a>

                                <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload"
                                       data-reload="tile-pie" type="checkbox"
                                       data-link=""
                                       id="subtask-check-radio"
                                />
                                <span class="lbl"> <p class="truncate name" data-subtaskid="" id="subtask-name"></p></span>
                                <span class="pull-right">
                                    <span class="list-button">
                                          <a href="" id="subtask-edit-href" data-toggle="mainmodal">
                                                <i class="icon dripicons-gear"></i>
                                          </a>
                                        </span>
                                  </span>
							...
							<?php echo form_close(); ?>
                            <ul id="task-subtasks-<?= $value->id ?>" class="task-subtasks todo sortlist sortable-list ui-sortable">
								<?php
								$subtasks = array_reverse($value->task_has_subtasks);
								foreach ($subtasks as $subtask) { ?>
                                    <li id="subtask_<?= $subtask->id; ?>"
                                        class="<?= $subtask->status; ?> list-item">

                                        <a href="<?= base_url() ?>projects/subtasks/<?= $project->id ?>/<?= $value->id; ?>/check/<?= $subtask->id; ?>"
                                           class="ajax-silent task-check"></a>

                                        <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload"
                                               data-reload="tile-pie" type="checkbox"
                                               data-link="<?= base_url() ?>projects/subtasks/<?= $project->id ?>/<?= $value->id; ?>/check/<?= $subtask->id; ?>" <?php if ( $subtask->status == "done" ) {
											echo "checked";
										} ?>
                                        />
                                        <span class="lbl"> <p class="truncate name"><?=$subtask->name?></p></span>
                                        <span class="pull-right">
                                            <?php if($subtask->worker_id) { ?>
	                                            <?php
	                                            $image = get_user_pic( $subtask->user->userpic, $subtask->user->email );
	                                            ?>
	                                            <?php if ( $image ) { ?>
                                                    <img class="img-circle list-profile-img tt"
                                                         title="<?= $subtask->user->firstname; ?> <?= $subtask->user->lastname; ?>"
                                                         src="<?= $image; ?>">
	                                            <?php } else { ?>
                                                    <a class="initials-avatar-circle tt"
                                                       title="<?php echo $subtask->user->firstname . ' ' . $subtask->user->lastname; ?>"><?php echo strtoupper( substr( $subtask->user->firstname, 0, 1 ) . substr( $subtask->user->lastname, 0, 1 ) ); ?></a>&nbsp;
	                                            <?php } ?>
                                            <?php } ?>
                                            <span class="list-button">
                                          <a href="<?= base_url(); ?>projects/subtasks/<?= $project->id ?>/<?= $value->id; ?>/update/<?= $subtask->id; ?>"
                                             data-toggle="mainmodal">
                                                <i class="icon dripicons-gear"></i>
                                          </a>
                                        </span>
                            ...
                            <li class="comment-list-li">
                                ...
                                <div class="form-group filled chat_message_input">
                                    ...
                                    <textarea name="message" class="form-control autogrow message summernote-with-mentions"
                                              placeholder="<?= $this->lang->line( 'application_write_message' ); ?>"></textarea>
                                    <span class="options">

                                          <i class="ion-ios-paperplane-outline tt chat-submit"
                                             title="<?= $this->lang->line( 'application_send' ); ?>"></i>
                                          <i class="ion-android-attach tt chat-attach"
                                             title="<?= $this->lang->line( 'application_attachment' ); ?>"></i>
                                          <input type="file" name="userfile"
                                                 data-image-holder="image_holder_<?= $value->id ?>"
                                                 class="chat-attachment hidden">
                                ...
                                <ul class="task-comments">
									...
									foreach ( $value->task_has_comments as $comments ) {
										...
										?>
                                        <li id="comment-<?=$value->id?><?=$comments->id?>">
											...
											<?php if ( $comments->attachment != "" ) { ?>
                                                <div>
													<?php if ( $mime[0] == "image" ) { ?>
                                                        <a href="<?= base_url() ?>files/media/<?= $comments->attachment_link ?>"
                                                           data-lightbox="image-<?= $comments->id ?>"
                                                           data-title="<?= $comments->attachment ?>">
                                                            <img
													...
													<?php } else { ?>
                                                        <a class="tt"
                                                           href="<?= base_url() ?>projects/download/false/<?= $comments->attachment_link ?>"
                                                           title="<?= $comments->attachment ?>">
    ...
    <div class="row tab-pane fade" role="tabpanel" id="milestones-tab">
        <div class="col-xs-12 col-sm-12 col-lg-6">
            <div class="table-head"><?= $this->lang->line( 'application_milestones' ); ?>
                <span class=" pull-right">
                      <a href="<?= base_url() ?>projects/milestones/<?= $project->id; ?>/add" class="btn btn-primary"
                         data-toggle="mainmodal">
					...
					foreach ( $project->project_has_milestones as $milestone ):
                        ...
                        <li id="milestoneLI_<?= $milestone->id; ?>" class="hasItems">
                            <h1 class="milestones__header ui-state-disabled">
								...
								<?= $milestone->name ?>
                                <span class="pull-right">
                  <a href="<?= base_url() ?>projects/milestones/<?= $milestone->project_id; ?>/update/<?= $milestone->id; ?>"
                     data-toggle="mainmodal"><i class="icon dripicons-gear milestone__header__right__icon"></i></a>
                </span>
                            </h1>
                            <ul id="milestonelist_<?= $milestone->id; ?>" class="sortable-list">
								<?php foreach ( $milestone->project_has_tasks as $value ): $count2 = $count2 + 1; ?>
                                    <li id="milestonetask_<?= $value->id; ?>"
                                        class="<?= $value->status; ?> priority<?= $value->priority; ?> list-item">
                                        <a href="<?= base_url() ?>projects/tasks/<?= $project->id; ?>/check/<?= $value->id; ?>"
                                           class="ajax-silent task-check"></a>
                                        <input name="form-field-checkbox"
                                               class="checkbox-nolabel task-check dynamic-reload" data-reload="tile-pie"
                                               type="checkbox"
                                               data-link="<?= base_url() ?>projects/tasks/<?= $project->id; ?>/check/<?= $value->id; ?>" <?php if ( $value->status == "done" ) {
											echo "checked";
										} ?>/>
                    ...
                    <?php if ( $value->user_id != 0 ) { ?>
	                    ...
	                    <?php } else { ?>
                            <a class="initials-avatar-circle tt"
                               title="<?php echo $value->user->firstname . ' ' . $value->user->lastname; ?>"><?php echo strtoupper( substr( $value->user->firstname, 0, 1 ) . substr( $value->user->lastname, 0, 1 ) ); ?></a>&nbsp;
	                    <?php } ?>
                    <?php } ?>
											<?php if ( $value->public != 0 ) { ?><span class="list-button"><i
                                                        class="icon dripicons-preview tt" title=""
                                                        data-original-title="<?= $this->lang->line( 'application_task_public' ); ?>"></i>
                                                </span><?php } ?>
                                            <a href="<?= base_url() ?>projects/tasks/<?= $project->id; ?>/update/<?= $value->id; ?>"
                                               class="edit-button" data-toggle="mainmodal"><i
        ...
        <div class="col-xs-12 col-sm-12 col-lg-6">
            ...
            <div class="subcont no-padding min-height-410">
                <ul id="task-list2" class="todo sortable-list">
					<?php $count3 = 0;
					foreach ( $tasksWithoutMilestone as $value ): $count3 = $count3 + 1; ?>
                        <li id="milestonetask_<?= $value->id; ?>"
                            class="<?= $value->status; ?> priority<?= $value->priority; ?> list-item">
                            <a href="<?= base_url() ?>projects/tasks/<?= $project->id; ?>/check/<?= $value->id; ?>"
                               class="ajax-silent task-check"></a>
                    ...
                    if ( $value->user_id != 0 ) {
	                    ...
	                    <?php if ( $image ) { ?>
                            <img class="img-circle list-profile-img tt"
                                 ...
                                 src="<?= $image; ?>">
	                    <?php } else { ?>
                            <a class="initials-avatar-circle list-profile-img tt"
                               title="<?php echo $value->user->firstname . ' ' . $value->user->lastname; ?>"
                               style="margin-right: 5px;"><?php echo strtoupper( substr( $value->user->firstname, 0, 1 ) . substr( $value->user->lastname, 0, 1 ) ); ?></a>&nbsp;
	                    <?php } ?>
                    <?php } ?>
								<?php if ( $value->public != 0 ) { ?><span class="list-button"><i
                                            class="icon dripicons-preview tt" title=""
                                ...
                                <a href="<?= base_url() ?>projects/tasks/<?= $project->id; ?>/update/<?= $value->id; ?>"
                                   class="edit-button" data-toggle="mainmodal"><i class="icon dripicons-gear"></i></a>
                    </span>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="table-head"><?= $this->lang->line( 'application_activities' ); ?>
                <span class=" pull-right"><a
                            class="btn btn-primary open-comment-box"><?= $this->lang->line( 'application_new_comment' ); ?></a></span>
            </div>
            <div class="subcont">
                ...
                <ul id="comments-ul" class="comments">
                    <li class="comment-item add-comment">
                        ...
                        <div class="comment-pic">
							...
							$image = get_user_pic( $this->user->userpic, $this->user->email );
							if ( $image ) { ?>
                                <img class="img-circle tt"
                                     title="<?= $this->user->firstname ?> <?= $this->user->lastname ?>"
                                     src="<?= $image; ?>">
							<?php } else { ?>
                                <a class="initials-avatar-circle tt"
                                   title="<?= $this->user->firstname ?> <?= $this->user->lastname ?>"><?= strtoupper( substr( $this->user->firstname, 0, 1 ) . substr( $this->user->lastname, 0, 1 ) ); ?></a>
							<?php } ?>
                        </div>
                        <div class="comment-content">
                            <h5><input type="text" name="subject" class="form-control" id="subject"
                                       placeholder="<?= $this->lang->line( 'application_subject' ); ?>..." required/>
                            </h5>
                            <p>
                                <small class="text-muted"><span
                                            class="comment-writer"><?= $this->user->firstname ?> <?= $this->user->lastname ?></span>
                                    <span class="datetime"><?php echo date( $core_settings->date_format . ' ' . $core_settings->date_time_format, time() ); ?></span>
                                </small>
                            </p>
                            <p><textarea class="input-block-level summernote" id="reply" name="message"
                                         placeholder="<?= $this->lang->line( 'application_write_message' ); ?>..."
                                         required/></textarea></p>
                            ...
                            <button id="cancel" name="cancel"
                                    class="btn btn-danger open-comment-box"><?= $this->lang->line( 'application_close' ); ?></button>
					...
					<?php foreach ( $project->project_has_activities as $value ): ?>
						...
						if ( $value->user_id != 0 ) {
							$initials = strtoupper( substr( $value->user->firstname, 0, 1 ) . substr( $value->user->lastname, 0, 1 ) );
							$writer   = $value->user->firstname . " " . $value->user->lastname;
							$image    = get_user_pic( $value->user->userpic, $value->user->email );
						} else {
							$initials = strtoupper( substr( $value->client->firstname, 0, 1 ) . substr( $value->client->lastname, 0, 1 ) );
                        ...
                        <li class="comment-item">
                            <div class="comment-pic">
								<?php if ( $writer != false ) { ?>
									...
									<?php } else { ?>
                                        <a class="initials-avatar-circle tt"
                                           title="<?= $writer ?>"><?= $initials ?></a>
									<?php } ?>
								<?php } else { ?> <i class="icon dripicons-rocket"></i> <?php } ?>
                            </div>
                            <div class="comment-content">
                                <h5><?= $value->subject; ?></h5>
                                <p>
                                    <small class="text-muted"><span class="comment-writer"><?= $writer ?></span> <span
									...
									<?php if ( $value->user_id == $this->user->id ) { ?>
                                        <a class="pull-right li-delete ajax-silent"
                                           href="<?= base_url(); ?>projects/activity/<?= $value->project_id; ?>/delete/<?= $value->id; ?>"><i
                                                    class="icon dripicons-trash"></i></a>
									<?php } ?>
                                </p>
                                <p><?= $value->message; ?></p>
                            </div>
                    ...
                    <li class="comment-item">
                        ...
                        <div class="comment-content">
                            ...
                            <p>
                                <small class="text-muted"><?php echo date( $core_settings->date_format . ' ' . $core_settings->date_time_format, $project->datetime ); ?></small>
                            </p>
    ...
    <div class="row tab-pane fade" role="tabpanel" id="chat-tab">

        <div class="col-xs-12 col-sm-12">
            <div class="table-head"><?= $this->lang->line( 'application_chat_history' ); ?>
                <span class="pull-right" id="result">result:
                </span>
            </div>

            <div class="tile-base no-padding">
                <div class="ch-history-container">
                    <div class="col-sm-6 col-sm-offset-3 ch-frame">
                        <div style="display: flex">
                            <div class="ch-input-container ch-macro" style="margin:auto">
                                <div class="ch-text ch-text-r" style="background:whitesmoke !important">
                                    <input class="ch-mytext ch-input" placeholder="Type a message"/>
                                </div>
                            </div>
                        </div>
                        <div class="ch-content-frame">
                            <ul class="ch-ul"></ul>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        var chatHistory = JSON.parse('<?php echo $chatHistory; ?>');
        var myInfo = JSON.parse('<?php echo $myInfo; ?>');
        for(i= chatHistory.length ; i>0; i--){
            var item = chatHistory[i-1];
            insertChat(item);
        }
        $(document).ready(function () {
            ...
            $(".ch-mytext").on("keyup", function(e){
                if (e.which == 13){
                    ...
                    if (text !== ""){
                        myInfo.chat_message = text;
                        myInfo.date_time = new Date();
                        insertChat(myInfo);
                        $(this).val('');
                        $('#result').html('result:');
                        ...
                        $.ajax({ //STARTS AJAX
                            type: 'POST',
                            url: '/slackintegration/slack_send_message/', //THIS PAGE IS LOADED ON THE AJAX data IS THE CONTENTS ON THE PAGE NOTE COMMA SEPARATED VALUES
                            data: data_msg,
                            dataType:"json",
                            ...
                            success: function(data){ //IF PAGE EXISTS OR FOUND THE data FROM THE GIVEN PAGE WILL BE LOADED AND PASSED
                                $('#result').html('result:' + data['msg']); //THE content ID ON THE PHP PAGE WILL CONTAIN ALL THE html data OF THE GIVEN PAGE

                                console.log("slack_message result : " + JSON.stringify(data));
                            }
                        });
                    }
                }
            ...
            if(comment_id != '-1') {
                setTimeout(function() {
                    $("#taskviewer-content").animate({
                        scrollTop: $("#comment-" + comment_id).position().top - 10
                    }, 1000);
                }, 1000);
            }
			<?php  } ?>
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            var params = parseHashBangArgs(hashTag);
            $('#projectTabs a[href="' + hashTag + '"]').tab('show');
