<div class="row">
			...
			<?php if($invoice->estimate_status != "Invoiced"){ ?><a href="<?=base_url()?>invoices/item/<?=$invoice->id;?>" class="btn btn-primary" data-toggle="mainmodal"><i class="icon dripicons-plus visible-xs"></i><span class="hidden-xs"><?=$this->lang->line('application_add_item');?></span></a><?php } ?>
			...
			<?php if($invoice->status != "Paid" && is_object($invoice->company) && is_object($invoice->company->client)){ ?><a href="<?=base_url()?>invoices/sendinvoice/<?=$invoice->id;?>" class="btn btn-primary"><i class="icon dripicons-mail visible-xs"></i><span class="hidden-xs"><?=$this->lang->line('application_send_invoice_to_client');?></span></a><?php } ?>
	...
	<div class="btn-group dropup">
      ...
      <li><a id="pay_credit_card" data-toggle="mainmodal" href="<?=base_url()?>invoices/propay/<?=$invoice->id;?>/<?=$sumRest;?>?paymentType=card"><?=$this->lang->line('application_credit_card');?></a></li>
      <li><a id="pay_check" data-toggle="mainmodal" href="<?=base_url()?>invoices/propay/<?=$invoice->id;?>/<?=$sumRest;?>?paymentType=ach"><?=$this->lang->line('application_check');?></a></li>
