...
<div class=" col-md-12" align="right">
	...
	<div class="btn-group dropup">
        ...
        <?php
         // if (isset($isSignedUp->AccountNumber) && $isSignedUp->AccountNumber > 0 && isset($isSignedUp->ProfileId) && $isSignedUp->ProfileId != null && $isSignedUp->ProfileId > 0) : 
        if (isset($isSignedUp->AccountNumber) && $isSignedUp->AccountNumber > 0  ) :
        ?>
            ...
            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                ...
                <li><a id="pay_credit_card" data-toggle="mainmodal" href="<?=base_url()?>cinvoices/propay/<?=$invoice->id;?>/<?=$sumRest;?>?paymentType=card"><?=$this->lang->line('application_credit_card');?></a></li>
                <li><a id="pay_check" data-toggle="mainmodal" href="<?=base_url()?>cinvoices/propay/<?=$invoice->id;?>/<?=$sumRest;?>?paymentType=ach"><?=$this->lang->line('application_check');?></a></li>
