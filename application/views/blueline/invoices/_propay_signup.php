...
?>
<?php //if (!$isSignedUp) : ?>
<div class="table-head">Spera <?= $this->lang->line( 'application_payments' ); ?> Existing Propay Account</div>
<div class="table-div">
    <div class="form-group">
        (previous Spera customers only)
    </div>
    <?php
    ...
    <div class="form-group"><label>PROPAY ACCOUNT NUMBER</label>
    ...
    <div class="form-group">
        <label><input class="required checkbox-padding" type="checkbox" name="signature" value="1" id="signature"> Click here to sign agreeing to the <a target="_blank" href="https://spera.io/payment-services-agreement/">terms and conditions</a></label>
    </div>
...
<div class="table-div">
    <?php if ($isSignedUp) : ?>
        <br> You are signed up for a propay account. You should have received a signup email.
