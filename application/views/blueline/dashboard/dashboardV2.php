<style>
  ...
  .row.mainnavbar {
    ...
    <div class="grid">
        <div class="grid__col-md-5 dashboard-header hidden-xs hide">
            <div class="grid grid--bleed grid--justify-end">
                <div class="grid__col-4 grid__col-lg-2 grid--align-self-center">
                    <h6><?= $this->lang->line( 'application_tasks' ); ?></h6>
                    <h2><?php if ( isset( $tasks ) ) {
							echo count( $tasks );
						} ?></h2>
                </div>
				<?php if ( $tickets_access ) { ?>
                    <div class="grid__col-4 grid__col-lg-2 grid--align-self-center">
                        <h6><a href="<?= base_url() ?>tickets/"><?= $this->lang->line( 'application_tickets' ); ?></a>
                        </h6>
                        <h2><a href="<?= base_url() ?>tickets/"><?= $ticketcounter; ?></a></h2>
                    </div>
				<?php } ?>
                <div class="grid__col-4 grid__col-lg-2 grid--align-self-center">
                    <h6><a href="<?= base_url() ?>clients/"><?= $this->lang->line( 'application_clients' ); ?></a></h6>
                    <h2><a href="<?= base_url() ?>clients/"><?= $clientcounter; ?></a></h2>
                </div>
            </div>
        </div>
        <div class="grid__col-sm-12 grid__col-md-12 grid__col-lg-12 grid__col--bleed">
            <div class="grid grid--align-content-start">
                ...
                <div class="grid__col-6 grid__col-xs-6 grid__col-sm-6 grid__col-md-6 grid__col-lg-3">
                    <div class="tile-base">
                        <div class="tile-icon hidden-md hidden-xs">
                            <img src="/assets/blueline/images/invoices-stat-icon.png"/>
                        </div>
                        <div class="tile-small-header">
                        ...
                        <div class="tile-body">
                            <div class="number" id="number2"><?php if ( empty( $paymentsoutstanding ) ) {
									...
									echo display_money( $paymentsoutstanding, $core_settings->currency );
								} ?></div>
                        </div>
                    </div>
                </div>
                <div class="grid__col-6 grid__col-xs-6 grid__col-sm-6  grid__col-md-6 grid__col-lg-3">
                    <a href="<?= base_url(); ?>projects" class="tile-base">
                        <div class="tile-icon hidden-md hidden-xs">
                            <img src="/assets/blueline/images/projects-stat-icon.png"/>
                        </div>
                        <div class="tile-small-header"><?= $this->lang->line( 'application_open_projects' ); ?></div>
                        <div class="tile-body" style="color: #EAAB10">
							<?= $projects_open; ?> / <?= $projects_all; ?>
                        </div>
                    </a>
                </div>
                <div class="grid__col-6 grid__col-xs-6 grid__col-sm-6 grid__col-md-6 grid__col-lg-3">
                    <a href="<?= base_url(); ?>invoices/filter/open" class="tile-base">
                        <div class="tile-icon hidden-md hidden-xs">
                            <img src="/assets/blueline/images/tickets-stat-icon.png"/>
                        </div>
                        <div class="tile-small-header"><?= $this->lang->line( 'application_open_invoices' ); ?></div>
                        <div class="tile-body" style="color: #892BBA">
							<?= $invoices_open; ?> / <?= $invoices_all; ?>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="grid__col-sm-12 grid__col-md-8 grid__col-lg-9 grid__col--bleed">
            <div class="grid grid--align-content-start">
				<?php if ( $this->user->admin == "1" ) { ?>
                    <div style="display: none;" class="grid__col-12 update-panel">
                        <div class="tile-base">
                            <div class="panel-heading red"><span
                                        class="title red"><?= $this->lang->line( 'application_update_available' ); ?></span><span
                                        id="hideUpdate" class="pull-right"><i class="ion-close"></i></span></div>
                    ...
                    <div class="grid__col-12">
                        <div class="tile-base no-padding">
                            <!-- <div class="table-head">Financial Stats</div> -->
							<?php //$totalIncomeForYear = $totalExpenses = $totalProfit = 0;
							//if ( $totalIncomeForYear || $totalExpenses || $totalProfit ) { ?>
                                <div class="tile-extended-header">
                                    <div class="grid tile-extended-header">
                                        <div class="grid__col-4">
                                            <h5><?= $this->lang->line( 'application_statistics' ); ?> </h5>
                                            <div class="btn-group">
                                                <button type="button" class="tile-year-selector dropdown-toggle"
                                                ...
                                                <ul class="dropdown-menu dropdown-menu--small" role="menu">
                                                    ...
                                                    <li>
                                                        <a href="<?= base_url() ?>dashboard/year/<?= date( "Y" ) - 1; ?>"><?= date( "Y" ) - 1; ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>dashboard/year/<?= date( "Y" ) - 2; ?>"><?= date( "Y" ) - 2; ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>dashboard/year/<?= date( "Y" ) - 3; ?>"><?= date( "Y" ) - 3; ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>dashboard/year/<?= date( "Y" ) - 4; ?>"><?= date( "Y" ) - 4; ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>dashboard/year/<?= date( "Y" ) - 5; ?>"><?= date( "Y" ) - 5; ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
							...
							<?php //} else { ?>
                                <!-- <div class="placeholder">
                                    <img src="/assets/blueline/images/financial-icon.png" height="50"/>
                                    <h3>Let’s get you paid, you’ve earned it!</h3>
                                    <a href="<?= base_url() ?>invoices/store" class="btn btn-danger">Send Your First Invoice</a>
                                </div> -->
							<?php //} ?>
                        </div>
                    </div> <?php } ?>
                                    ...
                                    <ul id="jp-container" class="todo jp-container">
										...
										foreach ( $tasks as $value ):
											...
											if ( is_object( $value->project ) && $projectname != $value->project->name ) {
												...
												echo "<h5><a href='" . base_url() . "projects/view/{$value->project->id}/tasks'>" . $projectname . "</a></h5>";
											}
											?>
                                            <li class="<?= $value->status; ?> priority<?= $value->priority; ?> list-item">
                                                <span class="lbl-">
                                                    <p class="truncate">
                                                        <input name="form-field-checkbox" type="checkbox" class="checkbox-nolabel task-check" data-link="<?= base_url() ?>projects/tasks/<?= $value->id; ?>/check" task="<?= $value->id; ?>" <?= $value->status; ?>/>
                                                        <a id="task-<?= $value->id; ?>" href="<?= base_url() ?>projects/view/<?= $value->project_id; ?>/tasks"><?= $value->name; ?></a>
                                                    </p>
                                                </span>
                                                ...
                                                <?php } ?>
                                                    <a href="<?= base_url() ?>projects/tasks/<?= $value->project_id; ?>/update/<?= $value->id; ?>" class="edit-button" data-toggle="mainmodal">
                ...
                <div class="grid__col-12">
                    ...
                    <div class="stdpad stdpad--auto-height">
                        <div class="table-head"><?= $this->lang->line( 'application_new_tickets' ); ?></div>
                        <div class="table-div">
                            <table class="table" id="tickets" rel="<?= base_url() ?>" cellspacing="0" cellpadding="0">
                                <thead>
                                <th class="hidden-xs no_sort" style="width:5px; padding-right: 5px;"><i
								...
								<?php foreach ( $ticket as $value ): ?>
                                    <tr id="<?= $value->id; ?>">
                                        ...
                                        <td class="hidden-xs"
                                            style="width:15px"><?php if ( $value->updated == "1" && $user_id == $this->user->id ) { ?>
                                                <i class="icon dripicons-star"
                                                   style="color: #d48b2a;"></i><?php } else { ?> <i
                                                    class="icon dripicons-star" style="opacity: 0.2;"></i><?php } ?>
                                        </td>
                                        <td><?= $value->subject; ?></td>
                                        <td class="hidden-xs hidden-md"><span><?php if ( is_object( $value->queue ) ) {
                                        ...
                                        <td class="hidden-xs hidden-md"><?php if ( ! is_object( $value->user ) ) {
        ...
        <div class="grid__col-sm-12 grid__col-md-4 grid__col-lg-3 grid__col--bleed">
            <div class="grid grid--align-content-start">
                ...
                <div class="grid__col-12">
                    <div class="stdpad placeholder">
                        <div class="text-center">
                            <img src="/assets/blueline/images/wallet-icon.svg" height="50"/>
                            <h3>Get Paid Faster!</h3>
                            <p>Get a FREE payments account and get paid with credit card or ACH instantly.</p>
                            <a href="/settings/merchant" class="btn btn-danger">Signup Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid__col-12 ">
                    <div class="stdpad">
                        <div class="table-head"><?= $this->lang->line( 'application_project_activities' ); ?></div>
                        <div id="main-nano-wrapper" class="nano">
                            <div class="nano-content">
								...
								<?php foreach ( $message as $value ): ?>
                                    <li>
                                        <a href="<?= base_url() ?>messages">
											...
											if ( $value->userpic_u ) {
												$pic      = get_user_pic( $value->userpic_u, $value->email_u );
												$initials = $value->sender_u;
											} else {
												$pic      = get_user_pic( $value->userpic_c, $value->email_c );
												$initials = $value->sender_c;
											}
											if ( $pic ) { ?>
                                                <img class="userpic img-circle" src="<?= $pic; ?>"/>
											<?php } else {
												echo '<span class="userpic initials-avatar-circle">' . strtoupper( substr( $initials, 0, 1 ) ) . '</span>';
											} ?>
                ...
                <div class="grid__col-12">
                    <div class="stdpad stdpad--auto-height stdpad--calendar">
...
<?php if ( $this->user->admin == "1" ) { ?>
  ...
  <?php } ?>
<?php
if (isset($_SESSION['cro'])) {
	switch (ENVIRONMENT) {
		case 'production':
			echo '<iframe style="display: none;" src="https://app.spera.io/signup/thankyou"></iframe>';
		case 'release':
			echo '<iframe style="display: none;" src="https://app.speratest.me/signup/thankyou"></iframe>';
		case 'development':
			echo '<iframe style="display: none;" src="https://dev.spera.io/signup/thankyou"></iframe>';
		default:
	}
}
?>
