        ...
        <div class="sidebar">
            ...
            <ul class="nav nav-sidebar">
				...
				if ( is_array( $menu ) || is_object( $menu ) ) { ?>
					<?php if ( in_array( $module_list['dashboard']['id'], $user_access ) ) { ?>
                      ...
                      <span class="menu-icon">
                          <i class="far fa-rocket"></i>
                                ...
                                <span class="nav-text"
                                      style="<?php echo $navopen ? "" : "display: none;" ?>"><?= $this->lang->line( 'application_dashboard' ) ?></span>
                            </a>
                        </li>
					<?php } ?>
					<?php if ( in_array( $module_list['projects']['id'], $user_access ) || in_array( $module_list['projects']['id'], $client_access ) ) { ?>
                        <li id="work"
                            class="<?php if ( $act_uri == 'projects' || $act_uri == 'tickets' || $act_uri == 'calendar' ) {
							    echo "active";
						    } ?>">
                      ...
                      <span class="menu-icon">
                          <i class="far fa-tasks"></i>
                                ...
                                <span class="nav-text"
                                      style="<?php echo $navopen ? "" : "display: none;" ?>"><?= $this->lang->line( 'application_work' ) ?></span>
                            </a>
                        </li>
					<?php } ?>
                    <li id="invoicing"
                        class="<?php if ( $act_uri == 'invoices' || $act_uri == 'estimates' || $act_uri == 'expenses' || $act_uri == 'items' || $act_uri == 'tinvoices' ) {
						    echo "active";
					    } ?>">
                      ...
                      <span class="menu-icon">
                          <i class="far fa-usd-circle"></i>
                            ...
                            <span class="nav-text"
                                  style="<?php echo $navopen ? "" : "display: none;" ?>"><?= $this->lang->line( 'application_money' ) ?></span>
                        </a>
                    </li>
                    <li id="people" class="<?php if ( $act_uri == 'team' || $act_uri == 'clients' ) {
						echo "active";
					} ?>">
                      ...
                      <span class="menu-icon">
                          <i class="far fa-users"></i>
                            ...
                            <span class="nav-text"
                                  style="<?php echo $navopen ? "" : "display: none;" ?>"><?= $this->lang->line( 'application_people' ) ?></span>
                        </a>
                    </li>
                    <li id="reports" class="<?php if ( $act_uri == 'reports' ) {
						echo "active";
					} ?>">
                      ...
                      <span class="menu-icon">
                          <i class="far fa-chart-pie"></i>
                            ...
                            <span class="nav-text"
                                  style="<?php echo $navopen ? "" : "display: none;" ?>"><?= $this->lang->line( 'application_reports' ) ?></span>
                        </a>
                    </li>
                    <li class="settings-button <?php if ( $act_uri == 'settings' ) {
                        echo "active";
                    } ?>">
                        <a href="<?= base_url() ?>settings">
                            ...
                            <span class="nav-text" style="<?php echo $navopen ? "" : "display: none;" ?>">Settings</span>
                        </a>
                    </li>
					<?php
					foreach ( $menu as $key => $value ) {
                        ...
                        <li id="<?= strtolower( $value->name ); ?>"
                            class="<?php if ( $act_uri == strtolower( $value->name ) ) {
							    echo "active";
						    } ?>">
                      ...
                      <span class="menu-icon">
                          <i class="fa <?= $value->icon; ?>"></i>
                                ...
                                <span class="nav-text" style="<?php echo $navopen ? "" : "display: none;" ?>">
                          <?php echo $this->lang->line( 'application_' . $value->link ); ?>
                      </span>
								<?php if ( strtolower( $value->name ) == "messages" && $messages_new[0]->amount != "0" ) {
									$message_icon = true; ?><span
                                            class="notification-badge"><?= $messages_new[0]->amount; ?></span><?php } ?>
								<?php if ( strtolower( $value->name ) == "quotations" && $quotations_new != "0" ) { ?>
                                    <span class="notification-badge"><?= $quotations_new; ?></span><?php } ?>
								<?php if ( strtolower( $value->name ) == "tickets" && $tickets_new != "0" ) { ?><span
                                        class="notification-badge"><?= $tickets_new; ?></span><?php } ?>
                            </a></li>
					<?php }
				} ?>
            </ul>
			...
			if ( is_array( $widgets ) || is_object( $widgets ) ) {
				...
				foreach ( $widgets as $key => $val ) {
					...
					if ( $sticky && $val->link == "quickaccess" ) { ?>
						<ul class="nav nav-sidebar quick-access menu-sub hidden-sm hidden-xs hide">
										...
										<ul>
											<?php if ( is_object( $value->company ) ) { ?>
												<li class="underline"><a
															href="<?= base_url() ?>clients/view/<?= $value->company_id; ?>"><b><?= $value->company->name ?></b></a>
												</li>
											<?php } ?>
											<li><a data-toggle="mainmodal"
												   href="<?= base_url() ?>projects/update/<?= $value->id; ?>"> <?= $this->lang->line( 'application_edit_project' ); ?>
											</li>
											<li><a data-toggle="mainmodal"
												   href="<?= base_url() ?>projects/tasks/<?= $value->id; ?>/add"> <?= $this->lang->line( 'application_add_task' ); ?>
											</li>
											<li><a href="<?= base_url() ?>projects/tracking/<?= $value->id; ?>"
												   id="<?= $value->id; ?>"><?php if ( empty( $value->tracking ) ) {
					...
					*/
					if ( $user_online && $val->link == "useronline" ) { ?>
                        ...
                        <ul class="nav nav-sidebar user-online menu-sub hidden-sm hidden-xs">
                            <h4 style="<?php echo $navopen ? "" : "display: none;" ?>"><?= $this->lang->line( 'application_user_online' ); ?></h4>
							<?php foreach ( $user_online as $value ):
                                ...
                                <li>
                                    <a href="#">
                                        <p class="truncate">
											<?php if ( get_user_pic( $value->userpic, $value->email ) == false ) { ?>
                                                <span class="initials-avatar-circle"><?= strtoupper( substr( $value->firstname, 0, 1 ) . substr( $value->lastname, 0, 1 ) ) ?></span>
											<?php } else { ?>
                                    ...
                                    <li>
                                        <a href="#" class="<?= $status; ?>">
                                            <p class="truncate"><img class="img-circle"
                                                                     src="<?php echo get_user_pic( $value->userpic, $value->email ); ?>"
                                                                     width="21px"> <?php echo $value->firstname . " " . $value->lastname; ?>
                                            </p>
                                        </a>
                                        <!-- <div class="submenu">
                                <ul>
    ...
    <div class="content-area" onclick="" style="<?php echo $navopen ? "margin-left: 200px;" : "margin-left: 55px;" ?>">
        <div class="mainnavbar">
            <div class="topbar__left">
                <div class="top-menu">
                    ...
                    <i class="far fa-bell topbar__icon fc-dropdown--trigger" data-placement="bottom"
                       title="<?= $this->lang->line( 'application_alerts' ); ?>"><?php if ( $notification_count > 0 ) { ?>
                            <span
                                    class="topbar__icon_alert"></span><?php } ?></i>
                    <div class="fc-dropdown notification-center">
                        <div class="notification-center__header">
                            <a href="#" data-href="#notifications-list"
                               class="active"><?= $this->lang->line( 'application_alerts' ); ?>
                                (<?= $notification_count; ?>)</a>
                            <a href="#" data-href="#mentions-list"><?= $this->lang->line( 'application_mentions' ); ?>
                                (<?= $mentions_count; ?>)</a>
                        </div>
                        <ul id="notifications-list" class="dropdown-content notificationlist">
							<?php
							...
							<?php if ( $notification_count == 0 ) { ?>
                                <li><p class="truncate"><?= $this->lang->line( 'application_no_events_yet' ); ?></p>
                                </li>
							<?php } ?>
                        </ul>
                        <ul id="mentions-list" class="dropdown-content mentionslist" style="display: none;">
							<?php
							foreach ( $mentions as $mention ): ?>
                                <li class="">
                                    <p class="truncate"><a href="<?= $mention->action ?>"><?= $mention->comment; ?></a>
                                    </p>
                                </li>
							<?php endforeach; ?>
							<?php if ( $mentions_count == 0 ) { ?>
                                <li><p class="truncate"><?= $this->lang->line( 'application_no_mentions_yet' ); ?></p>
                                </li>
							<?php } ?>
                        </ul>
                    </div>
					...
					if ( $message_icon ) { ?>
                      ...
                      <a href="<?= site_url( "messages" ); ?>"
                         title="<?= $this->lang->line( 'application_messages' ); ?>">
                         <i class="far fa-comment topbar__icon"></i>
                      </a>
                  </span>
					<?php } ?>
					<?php if ( isset( $projects_icon ) ) { ?>
                        <i id="i_task_alert" class="far fa-stopwatch topbar__icon fc-dropdown--trigger" data-placement="bottom"
                           title="<?= $this->lang->line( 'application_running_timers' ); ?>"><?php if ( $task_notifications ) { ?>
                        ...
                        <div class="fc-dropdown notification-center shortcut-menu">
                            ...
                            <ul id="ul_task_notifiction" class="notificationlist task__notifications details">
								<?php foreach ( $task_notifications as $value ) {
									$task_count = 1; ?>
                                    <li>
                                        <span><?= $value->project->name; ?></span>
                                        <a href="<?= base_url(); ?>projects/view/<?= $value->project_id; ?>/tasks"><?= $value->name; ?></a>
            ...
            <div class="topbar__right">
                <div class="add-icon" style="position: relative;">
                    ...
                    <ul class="dropdown-menu dropdown-menu--small" role="menu">
                        <?php if($this->user->admin == 0){?>
                          <li><a href="<?= base_url() ?>invoices/store">Add Invoice</a></li>
                        <?php } ?>
                        
                        <li><a href="<?= base_url() ?>projects/create" data-toggle="mainmodal">Add Project</a></li>
                        <li><a href="<?= base_url() ?>estimates/store">Add Estimate</a></li>
                        <li><a data-toggle="modal" data-target="#addTeamModal" style="cursor: pointer;">Add Team Member</a></li>
                    </ul>
                </div>
                <div class="profile-icon">
					...
					<?php } else { ?>
                        <span class="topbar__userimage"><?php echo strtoupper( substr( $this->user->firstname, 0, 1 ) . substr( $this->user->lastname, 0, 1 ) ); ?></span>
					<?php } ?>
                    <span class="topbar__name fc-dropdown--trigger">
                    <span class="hidden-xs"><?php echo character_limiter( $this->user->firstname . " " . $this->user->lastname, 10 ); ?></span> <i
        ...
        <div class="row mainnavbar" style="display: none;">
				...
				<?php if ( isset( $projects_icon ) ) { ?>
                    ...
                    <div class="fc-dropdown notification-center shortcut-menu">
                        ...
                        <ul class="notificationlist task__notifications details">
							...
							<?php } ?>
							<?php if ( ! isset( $task_count ) ) { ?>
                                <li><p class="truncate"><?= $this->lang->line( 'application_no_timers_running' ); ?></p>
                                </li>
							<?php } ?>
                        </ul>
                    </div>
            ...
            <div class="topbar noselect">
                ...
                <span class="topbar__name fc-dropdown--trigger">
          <span class="hidden-xs"><?php echo character_limiter( $this->user->firstname . " " . $this->user->lastname, 25 ); ?></span> <i
