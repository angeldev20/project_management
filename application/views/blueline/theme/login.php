...
<body class="login" style="background-image:url('https://spera-<?=ENVIRONMENT ?>.s3-us-west-2.amazonaws.com/<?php echo (isset($_SESSION['accountUrlPrefix'])) ? $_SESSION['accountUrlPrefix'] : 'default';?>/assets/blueline/images/backgrounds/<?=$core_settings->login_background;?>')">
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        setTimeout(function(){ $('input[type="password"]').val(''); }, 500);
    });
