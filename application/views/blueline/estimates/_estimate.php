...
<?php } ?>
 ...
 <div class="form-group">
        ...
        <input class="form-control" name="discount" id="appendedInput" type="text" value="<?php if(isset($estimate)){ echo $estimate->discount;} else {echo '0.00';} ?>"/>
 </div>
 <div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
        ...
        <input class="form-control" name="second_tax" type="text" value="<?php if(isset($estimate)){ echo $estimate->second_tax;} else {echo '0.00';} ?>"/>
 </div>
