          ...
          <div class="row">
			...
			<?php if($estimate->estimate_status != "Declined" && $estimate->estimate_status != "Invoiced" && $estimate->estimate_status != "Accepted"){ ?><a href="<?=base_url()?>cestimates/decline/<?=$estimate->id;?>" class="btn btn-danger" data-toggle="mainmodal"><i class="icon dripicons-cross visible-xs"></i><span class="hidden-xs"><?=$this->lang->line('application_decline');?></span></a><?php } ?>
			<?php if($estimate->estimate_status != "Accepted" && $estimate->estimate_status != "Invoiced"){ ?><a href="<?=base_url()?>cestimates/accept/<?=$estimate->id;?>" class="btn btn-success"><i class="icon dripicons-checkmark visible-xs"></i><span class="hidden-xs"><?=$this->lang->line('application_accept');?></span></a><?php } ?>
