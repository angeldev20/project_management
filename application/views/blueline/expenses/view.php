          ...
          <div class="row">
			...
			<?php if($estimate->estimate_status == "Open" && isset($estimate->company->name)){ ?><a href="<?=base_url()?>estimates/sendestimate/<?=$estimate->id;?>" class="btn btn-primary"><i class="icon dripicons-mail visible-xs"></i><span class="hidden-xs"><?=$this->lang->line('application_send_estimate_to_client');?></span></a><?php } ?>
