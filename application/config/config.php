...
/**
 * Include aws access into the config
 */
$config['aws_access_key'] = AWS_ACCESS_KEY_ID;
$config['aws_secret_key'] = AWS_SECRET_ACCESS_KEY;
...
{
    if(stripos($_SERVER["REQUEST_URI"],'/paypalipn') === FALSE
        && stripos($_SERVER["REQUEST_URI"],'/login') === FALSE
        && stripos($_SERVER["REQUEST_URI"],'/slackintegration' ) === FALSE )
    {
