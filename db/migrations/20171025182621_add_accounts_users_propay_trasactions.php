...
class AddAccountsUsersPropayTrasactions extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table = $this->table('accounts_users_propay_transactions');
        $table
            ...
            ->addColumn('TimedPullStatus', 'string',['limit' => 2, 'null' => true])
            ->addColumn('created', 'date',['null' => false])
            ->addIndex(['payorAccountUrlPrefix', 'payorUsername', 'payeeAccountUrlPrefix', 'payeeUsername', 'HostedTransactionIdentifier'], ['unique' => true])
            ->addIndex(['payorAccountUrlPrefix', 'payorUsername', 'payeeAccountUrlPrefix', 'payeeUsername', 'invoiceNumber', 'HostedTransactionIdentifier', 'TransactionId', 'created'], ['unique' => false])
            ->create();
        $table = $this->table('accounts_users_propay_transactions');
        $table
