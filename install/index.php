...
<html lang="en">
  <head>
    ...
    <title>Freelance Cockpit - Installation</title>
  ...
  <body class="install">
    <div class="container-fluid">
      ...
      <div class="col-xs-12 col-lg-8 col-lg-offset-2 install-frame">  
        <div class="logo"><img src="../assets/blueline/images/FC2_logo_light_.png"></div>
...
<!-- Modal -->
  ...
  <div class="modal-dialog">
    ...
    <script src="../assets/blueline/js/plugins/jquery-1.12.4.min.js"></script>
